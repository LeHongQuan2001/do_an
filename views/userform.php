  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>views/process.php?cmd=create" method="post">
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <span id="sprytf_name">
		<input type="text" name="idname" class="form-control input-sm" placeholder="Username">
		<span class="textfieldRequiredMsg">Name is required.</span>
		<span class="textfieldMinCharsMsg">Name must specify at least 6 characters.</span>
		</span>
      </div>
      <div class="form-group">
        ...
        <span id="sprytf_name">
		<input type="text" name="fullname" class="form-control input-sm" placeholder="Full name">
		<span class="textfieldRequiredMsg"> Full name is required.</span>
		<span class="textfieldMinCharsMsg"> Full name must specify at least 6 characters.</span>
		</span>
      </div>
