      ...
      <tr>
        ...
        ?>
          <tr>
            ...
            <td>
              <i class="fa <?php echo $type == 'teacher' ? 'fa-user' : 'fa-users'; ?>" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo strtoupper($type); ?></i>
            </td>
            <td><?php echo $full_name; ?></td>
            <td style="text-align: center;"><span class="label label-<?php echo $stat; ?>"><?php echo strtoupper($status); ?></span></td>
            <?php if ($utype == 'on') { ?>
              <td><?php if ($status == "active") { ?>
                  <a class="btn btn-primary" href="javascript:status('<?php echo $user_id ?>', 'inactive');">Inactive</a>&nbsp;
                  &nbsp;<a class="btn btn-warning" href="javascript:status('<?php echo $user_id ?>', 'lock');">Account Lock</a>&nbsp;
                  &nbsp;<a class="btn btn-danger" href="javascript:status('<?php echo $user_id ?>', 'delete');">Delete</a>
                <?php } else { ?>
